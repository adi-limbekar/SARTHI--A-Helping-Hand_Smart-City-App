    ...
    public void onClick(View v)
    {
        ...
        switch(v.getId())
        {
            ...
            case R.id.B_hopistals:
                ...
                Toast.makeText(NearbyMapActivity.this, "Searching Nearby Hospitals", Toast.LENGTH_LONG).show();
                break;
            ...
            case R.id.B_schools:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(NearbyMapActivity.this, "Searching Nearby Schools", Toast.LENGTH_LONG).show();
                break;
            case R.id.B_restaurants:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(NearbyMapActivity.this, "Searching Nearby Restaurants", Toast.LENGTH_LONG).show();
                break;
            case R.id.B_atm:
                mMap.clear();
                String atm = "atm";
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(NearbyMapActivity.this, "Searching Nearby ATMs...", Toast.LENGTH_LONG).show();
                break;
            case R.id.B_lib:
                mMap.clear();
                String lib = "library";
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(NearbyMapActivity.this, "Searching Nearby Libraries...", Toast.LENGTH_LONG).show();
                break;
            case R.id.B_gym:
                mMap.clear();
                String g = "gym";
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(NearbyMapActivity.this, "Searching Nearby Gyms...", Toast.LENGTH_LONG).show();
                break;
        }
    }
